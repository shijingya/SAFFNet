...
class PATH:
    ...
    def init_path(self):
        ...
        # self.DATA_ROOT = '/home/shenxiang/PublicDatasets/vqa_grid'
        self.DATA_ROOT = '/home/shenxiang/sda/Datasets/vqa_grid'
        ...
        self.FEATS_PATH = {
            'vqa': {
                'train': self.DATA_ROOT + '/feats' + '/train2014',
                'val': self.DATA_ROOT + '/feats' + '/val2014',
                'test': self.DATA_ROOT + '/feats' + '/test2015',
            },
            'clevr': {
        ...
        self.RAW_PATH = {
            'vqa': {
                'train': self.DATA_ROOT+ '/raw' + '/v2_OpenEnded_mscoco_train2014_questions.json',
                'train-anno': self.DATA_ROOT + '/raw' + '/v2_mscoco_train2014_annotations.json',
                'val': self.DATA_ROOT + '/raw' + '/v2_OpenEnded_mscoco_val2014_questions.json',
                'val-anno': self.DATA_ROOT + '/raw' + '/v2_mscoco_val2014_annotations.json',
                'vg': self.DATA_ROOT + '/raw' + '/VG_questions.json',
                'vg-anno': self.DATA_ROOT + '/raw' + '/VG_annotations.json',
                'test': self.DATA_ROOT + '/raw' + '/v2_OpenEnded_mscoco_test2015_questions.json',
            },
            'clevr': {
